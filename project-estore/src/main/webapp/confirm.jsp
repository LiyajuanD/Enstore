...
<div class="content">
    <div class="contentCenter">
        ...
        <form action="/ordercommit" name="orderForm">
            ...
            <div class="centerTop">
                ...
                <ul class="adres">
                    <c:forEach items="${Address}" var="addre" varStatus="as">
                        <li>

                            <input type="radio" name="shipAddId" value="${addre.id}" style="width:50px">
                            ${addre.receiveName}&nbsp;&nbsp;&nbsp;${addre.phone}&nbsp;&nbsp;&nbsp;${addre.address}
                        </li>
                    </c:forEach>
                </ul>
            ...
            <div class="bigDiv">
                <div class="twoDiv">
                    <b>商家：briup自营</b>
                    <c:forEach items="${confrim}" var="confrim">
                        <ul class="oneUL">
                            <li>
                                <img src="${confrim.book.image}" class="pic">
                                <p>${confrim.book.name}</p>
                                <p><font>¥${confrim.book.price}</font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;×${confrim.num}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;有货</p>
                                <c:set var="total" value="${total+confrim.book.price*confrim.num}"></c:set>
            ...
            <div class="money">
                <span><font>${confrim.size()}</font>件商品，总商品金额：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;¥${total}</span>
